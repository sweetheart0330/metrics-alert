...
func (m *MockIClient) SendMetricsBatch(metrics []models.Metrics, log *zap.SugaredLogger) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendMetricsBatch", metrics, log)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendMetricsBatch indicates an expected call of SendMetricsBatch.
func (mr *MockIClientMockRecorder) SendMetricsBatch(metrics, log any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMetricsBatch", reflect.TypeOf((*MockIClient)(nil).SendMetricsBatch), metrics, log)
}
